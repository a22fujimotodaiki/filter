...
class mpu6050:
    ...
    def get_gyro_data(self, rad=True):
...
if __name__ == "__main__":
    mpu = mpu6050(0x68)
    print(mpu.get_temp(),end='')
    print(",",end='')
    accel_data = mpu.get_accel_data()
    print(accel_data['x'],end='')
    print(",",end='')
    print(accel_data['y'],end='')
    print(",",end='')
    print(accel_data['z'],end='')
    print(",",end='')
    gyro_data = mpu.get_gyro_data()
    print(gyro_data['x'],end='')
    print(",",end='')
    print(gyro_data['y'],end='')
    print(",",end='')
    print(gyro_data['z'])
